...
def plot_detectedstars(image_with_stars,image,blurred_image,thresholded_image):
    plt.figure()
    plt.subplot(144)
...
def plot_centroids(image_with_stars,ra_vals, dec_vals):
...
def plot_detectedstars_with_catalogue(ra_vals,dec_vals,catalog_ra,catalog_dec):
...
def plot_matched_stars(matched_detected_coords,matched_catalog_coords,matched_names):
